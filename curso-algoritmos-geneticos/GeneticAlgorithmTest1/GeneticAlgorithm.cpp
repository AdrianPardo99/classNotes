...
GeneticAlgorithm::GeneticAlgorithm(int populationSize,int generation, int tournamentGroupSize,
	double crossoverProbability,double mutationProbability):
	mPopulationSize{populationSize},mGenerations{generation},
	mTournamentGroupSize{tournamentGroupSize},mCrossoverProbability{crossoverProbability},
